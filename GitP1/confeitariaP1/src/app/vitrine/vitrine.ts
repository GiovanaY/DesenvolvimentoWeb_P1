...
export class Vitrine {
  ...
  lista: Produto[] = [
    ...
    },
    {
      ...
      "descritivo": "Se você pudesse provar a felicidade, ela teria a forma desta mini torta. Uma combinação perfeita que conquista na primeira mordida e deixa aquele desejo de querer... mais uma.",
      "valor": 26.50,
      "quantidade": 15,
      "destaque": 1
    },
    ...
    {
      "codigo": 5,
      "nome": "Torta Tiramisù Vegana & Sem Glúten",
